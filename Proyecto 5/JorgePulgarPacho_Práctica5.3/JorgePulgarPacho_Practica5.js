...
function showLoadingScreen() {
    return new Promise((resolve) => {
        ...
        // Oculto el tutorial y la <ona de juego porque me parece que con la transparencia de la pantalla de carga queda más bonito; porque parece que está cargando desde la pantalla inicial
        document.getElementById('tutorial-container').style.display = 'none'
